...
a persistence unit "product_crudPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "product_crud/pom.xml":
...
artifact ("product_crud.war") is already built. You can build
